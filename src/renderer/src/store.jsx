...
export function StoreProvider({ children }) {
  ...
  async function login(username, password) {
    ...
    try {
      ...
      localStorage.setItem('barcodeShowName', settings?.barcodeShowName !== false ? 'true' : 'false')
      localStorage.setItem('barcodeShowPrice', settings?.barcodeShowPrice !== false ? 'true' : 'false')
      localStorage.setItem('barcodeScale', String(settings?.barcodeScale ?? 1.0))
      localStorage.setItem('barcodeFontWeight', settings?.barcodeFontWeight || 'bold')
      localStorage.setItem('showQR', settings?.showQR !== false ? 'true' : 'false')
  ...
  async function updateSettings(newSettings) {
    ...
    const updated = await api.saveSettings(token, newSettings)
      ...
      localStorage.setItem('barcodeShowName', updated?.barcodeShowName !== false ? 'true' : 'false')
      localStorage.setItem('barcodeShowPrice', updated?.barcodeShowPrice !== false ? 'true' : 'false')
      localStorage.setItem('barcodeScale', String(updated?.barcodeScale ?? 1.0))
      localStorage.setItem('barcodeFontWeight', updated?.barcodeFontWeight || 'bold')
      localStorage.setItem('showQR', updated?.showQR !== false ? 'true' : 'false')
