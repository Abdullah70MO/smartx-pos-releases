...
export default function SuppliersPage() {
  ...
  return (
    <div style={{ padding: '20px', overflow: 'auto', height: '100%' }}>
      ...
      <Modal open={!!transModal} onClose={() => setTransModal(null)} title={`عمليات المورد: ${transModal?.name}`} width={settings?.printDefaultSize === 'a4' ? '700px' : '380px'}>
        <div id="supplier-print-statement">
